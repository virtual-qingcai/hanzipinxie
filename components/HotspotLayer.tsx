        ...
        >
          ...
          {mode === 'view' && (
            <div className="absolute inset-0 rounded-xl transition-all duration-700 pointer-events-none">
              <div className="w-full h-full border-4 border-amber-400/50 bg-amber-400/5 shadow-[0_0_15px_rgba(251,191,36,0.5)] animate-pulse group-hover:bg-amber-400/20 group-hover:border-amber-500 rounded-xl"></div>
            </div>
          )}
        </div>
      ))}
